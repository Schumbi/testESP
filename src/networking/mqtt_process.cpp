...
namespace Mqtt {
    ...
    void Process::startMqtt()
    {
        ...
        if (_mqtt_client != nullptr) {
            ...
            _mqtt_client->set_server(_config.mqtt_broker, _config.mqtt_port);

            using namespace std::placeholders;
            //_mqtt_client->set_callback(std::bind(&Abstract_Message_Processor::mqttMessageCallback, _config.msg_processor, _1, _2, _3));
            reconnect();
        }
        END;
    }
